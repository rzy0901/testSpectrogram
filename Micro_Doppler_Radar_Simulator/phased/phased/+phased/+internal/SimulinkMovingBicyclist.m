classdef (Sealed) SimulinkMovingBicyclist < phased.internal.AbstractMovingBicyclist & matlab.system.mixin.CustomIcon & ...
...
%#codegen
    ...
    methods 
        function obj = SimulinkMovingBicyclist(varargin)
    ...
    methods (Access=protected)
        function flag = isInactivePropertyImpl(obj,prop)
            ...
            flag = isInactivePropertyImpl@phased.internal.AbstractMovingBicyclist(obj,prop);
        end
        ...
        function icon = getIconImpl(obj) %#ok<MANU>
            ...
            icon = "Moving Bicyclist"; 
            
        end

        function [name,name2,name3] = getInputNamesImpl(obj) %#ok<MANU>
        ...
        function [name,name2,name3] = getOutputNamesImpl(obj) %#ok<MANU>
        ...
        function validateStepInputs(obj,heading,speed,coast)
        ...
        function [scattererspos,scatterersvel,scatterersaxes] = stepImpl(obj,varargin)   
            if strcmpi(obj.InputSource,'Input port')
                validateStepInputs(obj,varargin{:}); 
            else
