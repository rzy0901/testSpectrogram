classdef (Hidden) AbstractSteeringVector < phased.internal.AbstractArrayOperation & ...
...
%#codegen    
    ...
    properties (Hidden, Nontunable, Access={?phased.ArrayResponse,...
            ?phased.internal.AbstractSubarray,?phased.internal.AbstractSteeringVector})
    ...
    methods (Access = protected)
        ...
        function obj = AbstractSteeringVector(varargin)
...
%                         disablePolarization(hele)
        ...
        function validateAngleInputs(obj,ang,stang)
        ...
        function sv = computeSteeringVector(obj,freq,angArg,stangArg,c)
            if size(angArg,1)==1
