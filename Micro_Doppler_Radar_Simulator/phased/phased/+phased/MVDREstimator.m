classdef (Sealed,StrictDefaults) MVDREstimator < phased.internal.AbstractULASpectralDOA
%MVDREstimator MVDR spatial spectrum estimator for ULA
%   H = phased.MVDREstimator creates an MVDR spatial spectrum estimator
%   System object, H. The object estimates the incoming signal's spatial
%   spectrum using a narrowband MVDR beamformer for a uniform linear array
%   (ULA).
%
%   H = phased.MVDREstimator(Name,Value) creates an MVDR spatial spectrum
...
%   equivalent.
%
%   MVDREstimator methods:
%
%   step         - Perform spatial spectrum estimation (see above)
%   release      - Allow property value and input characteristics changes
%   clone        - Create an MVDR spatial spectrum estimator object with 
%                  same property values
%   isLocked     - Locked status (logical)
%   <a href="matlab:help matlab.System/reset   ">reset</a>        - Reset states of MVDR spatial spectrum estimator object
%   plotSpectrum - Plot spatial spectrum
%
%   MVDREstimator properties:
%
...
%
%   See also phased, phased.MVDREstimator2D, broadside2az.
