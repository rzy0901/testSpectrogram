classdef (Sealed) clusterDBSCAN < phased.internal.AbstractClusterDBSCAN
...
%
%   [IDX,CLUSTERIDS] = step(H,X,AMBLIMS,UPDATE) is the full syntax with all
...
%#codegen
    ...
    methods 
        function obj = clusterDBSCAN(varargin)
    ...
    methods (Access=protected)
        ...
        function [idx, clusterIDs] = stepImpl(obj,x,varargin)
