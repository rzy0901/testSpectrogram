...
%    File Name:     max_power_ray_conf5.m
%    Authors:       Y. Gagiev
%    Version:       1.0
...
%    Description:
%
%    Executes max power ray alg for configuration #5
%
...
%
%  *************************************************************************************/
function [imp_res] = max_power_ray_conf5(cfg, ch)
...
[power_max_h11, idx_max_h11] = max(abs(ch.am_h11).^2);
...
[power_max_h12, idx_max_h12] = max(abs(ch.am_h12).^2);
