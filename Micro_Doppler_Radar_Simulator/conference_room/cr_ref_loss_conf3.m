...
%
%    [ref_loss11, ref_loss12, ref_loss21, ref_loss22] = cr_ref_loss_conf3()
%
%    Outputs:
%
%       1. ref_loss11 - reflection loss coefficients array for tx_pol(1) -> rx_pol(1) polarization
%       2. ref_loss12 - reflection loss coefficients array for tx_pol(1) -> rx_pol(2) polarization
%       3. ref_loss21 - reflection loss coefficients array for tx_pol(2) -> rx_pol(1) polarization
%       4. ref_loss22 - reflection loss coefficients array for tx_pol(2) -> rx_pol(2) polarization
%
%    Inputs:
%
%       1. ap_sp    - parameter selects subscenario: 0 - STA-STA, 1 - STA-AP
%       2. tx_pol   - antennas polarization type for PAAs on Tx side
%       3. rx_pol   - antennas polarization type for PAAs on Rx side
%
...
%
%  *************************************************************************************/
function [ref_loss11, ref_loss12, ref_loss21, ref_loss22] = cr_ref_loss_conf3(ap_sp, tx_pol, rx_pol)

% polarization vectors for TX and RX antennas
tx_pol_v = polarization(tx_pol(1));
tx_pol_h = polarization(tx_pol(2));
                
rx_pol_v = polarization(rx_pol(1));
rx_pol_h = polarization(rx_pol(2));
